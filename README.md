...
| #   | 论文 | 笔记 | 状态 | 日期 | 路线 |
| --- | ---- | ---- | ---- | ---- | ---- |
| 1   | PPO: Proximal Policy Optimization | [[PPO_Proximal_Policy_Optimization]] | 📖 进行中 | - | 基础RL |
| 2   | AWR: Advantage Weighted Regression | [[AWR_Advantage_Weighted_Regression]] | ⏳ 待读 | - | 基础RL |
| 3   | DeepMimic: Example-Guided Deep RL of Physics-Based Character Skills | [[DeepMimic_Example-Guided_Deep_RL_of_Physics-Based_Character_Skills]] | ⏳ 待读 | - | 精确模仿 |
| 4   | AMP: Adversarial Motion Priors for Stylized Physics-Based Character Control | [[AMP_Adversarial_Motion_Priors]] | ⏳ 待读 | - | 风格学习 |
| 5   | PHC: Perpetual Humanoid Control for Real-time Simulated Avatars | [[PHC_Perpetual_Humanoid_Control]] | ⏳ 待读 | - | 精确模仿 |
| 6   | ADD: Adversarial Disentanglement and Distillation | [[ADD_Adversarial_Disentanglement_and_Distillation]] | ⏳ 待读 | - | 风格学习 |
| 7   | ASE: Adversarial Skill Embeddings for Large-Scale Motion Control | [[ASE_Adversarial_Skill_Embeddings]] | ⏳ 待读 | - | 技能组合 |
| 8   | CALM: Conditional Adversarial Latent Models for Directable Virtual Characters | [[CALM_Conditional_Adversarial_Latent_Models]] | ⏳ 待读 | - | 技能组合 |
| 9   | PULSE: Physically Plausible Universal Latent Skill Extraction | [[PULSE_Physically_Plausible_Universal_Latent_Skill_Extraction]] | ⏳ 待读 | - | 技能组合 |
| 10  | Diffusion Policy: Visuomotor Policy Learning via Action Diffusion | [[Diffusion_Policy_Visuomotor_Policy_Learning]] | ⏳ 待读 | - | 扩散+控制 |
| 11  | BeyondMimic: From Motion Tracking to Versatile Humanoid Control via Guided Diffusion | [[BeyondMimic_From_Motion_Tracking_to_Versatile_Humanoid_Control]] | ⏳ 待读 | - | 扩散+控制 |
| 12  | Domain Randomization for Transferring Deep Neural Networks from Simulation to the Real World | [[Domain_Randomization_Sim-to-Real_Transfer]] | ⏳ 待读 | - | Sim-to-Real |
| 13  | LCP: Sim-to-Real Action Smoothing | [[LCP_Sim-to-Real_Action_Smoothing]] | ⏳ 待读 | - | Sim-to-Real |
