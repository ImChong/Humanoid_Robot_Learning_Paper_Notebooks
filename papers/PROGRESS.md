...
| 38   | [EgoHumanoid: Unlocking In-the-Wild Loco-Manipulation with Robot-Free Egocentric Demonstration](https://arxiv.org/abs/2602.10106)                                | 2026-04-30 |     | ✅ 完成 |
...
| 193  | [HoRD: Robust Humanoid Control via History-Conditioned Reinforcement Learning and Online Distillation](https://arxiv.org/abs/2602.04412)                        | 2026.02 |     | ⏳ 待读 |
| 194  | [CMR: Contractive Mapping Embeddings for Robust Humanoid Locomotion on Unstructured Terrains](https://arxiv.org/abs/2602.03511)                                 | 2026.02 |     | ⏳ 待读 |
| 195  | [RPL: Learning Robust Humanoid Perceptive Locomotion on Challenging Terrains](https://arxiv.org/abs/2602.03002)                                                 | 2026.02 |     | ⏳ 待读 |
| 196  | [FastStair: Learning to Run Up Stairs with Humanoid Robots](https://arxiv.org/abs/2601.10365)                                                                   | 2026.01 |     | ⏳ 待读 |
| 197  | [Walk the PLANC: Physics-Guided RL for Agile Humanoid Locomotion on Constrained Footholds](https://arxiv.org/abs/2601.06286)                                    | 2026.01 |     | ⏳ 待读 |
| 198  | [SKATER: Synthesized Kinematics for Advanced Traversing Efficiency on a Humanoid Robot via Roller Skate Swizzles](https://arxiv.org/abs/2601.04948)             | 2026.01 |     | ⏳ 待读 |
| 199  | Walk the PLANC: Physics‑Guided RL for Agile Humanoid LocomotioN on Constrained Footholds                                                                        | 2026.01 |     | ⏳ 待读 |
| 200  | [Do You Have Freestyle? Expressive Humanoid Locomotion via Audio Control](https://arxiv.org/abs/2512.23650)                                                     | 2025.12 |     | ⏳ 待读 |
...
| #   | 论文                                                                                                                                                        | 日期      | 🌟  | 状态   |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | --- | ---- |
| 271  | [HumDex: Humanoid Dexterous Manipulation Made Easy](https://arxiv.org/abs/2603.12260)                                                                     | 2026.03 |     | ⏳ 待读 |
...
| 276  | [DexterCap: An Affordable and Automated System for Capturing Dexterous Hand-Object Manipulation](https://arxiv.org/abs/2601.05844)                        | 2026.01 |     | ⏳ 待读 |
| 277  | [Genie Sim 3.0 : A High-Fidelity Comprehensive Simulation Platform for Humanoid Robot](https://arxiv.org/abs/2601.02078)                                  | 2026.01 |     | ⏳ 待读 |
| 278  | Visual-tactile pretraining and online multitask learning for humanlike manipulation dexterity                                                             | 2026.01 |     | ⏳ 待读 |
| 279  | [SafeHumanoid: VLM-RAG-driven Control of Upper Body Impedance for Humanoid Robot](https://arxiv.org/abs/2511.23300)                                       | 2025.11 |     | ⏳ 待读 |
...
| 282  | [RGMP: Recurrent Geometric-prior Multimodal Policy for Generalizable Humanoid Robot Manipulation](https://arxiv.org/abs/2511.09141)                       | 2025.11 |     | ⏳ 待读 |
...
| #   | 论文                                                                                                                                                             | 日期      | 🌟  | 状态   |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | --- | ---- |
| 329  | [CLOT: Closed-Loop Global Motion Tracking for Whole-Body Humanoid Teleoperation](https://arxiv.org/abs/2602.15060)                                             | 2026.02 |     | ⏳ 待读 |
...
| 334  | [Development of an Intuitive GUI for Non-Expert Teleoperation of Humanoid Robots](https://arxiv.org/abs/2510.13594)                                            | 2025.10 |     | ⏳ 待读 |
| 335  | [Stability-Aware Retargeting for Humanoid Multi-Contact Teleoperation](https://arxiv.org/abs/2510.04353)                                                       | 2025.10 |     | ⏳ 待读 |
| 336  | [LapSurgie: Humanoid Robots Performing Surgery via Teleoperated Handheld Laparoscopy](https://arxiv.org/abs/2510.03529)                                        | 2025.10 |     | ⏳ 待读 |
...
| 354  | [Quantum deep reinforcement learning for humanoid robot navigation task](https://arxiv.org/abs/2509.11388)                                                 | 2025.09 |     | ⏳ 待读 |
...
| 365  | [Gallant: Voxel Grid-based Humanoid Locomotion and Local-navigation across 3D Constrained Terrains](https://arxiv.org/abs/2511.14625) | 2025.11 |  | ⏳ 待读 |
...
| #   | 论文                                                                                                                                       | 日期      | 🌟  | 状态   |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------- | ------- | --- | ---- |
| 368  | [AutoOdom: Learning Auto-regressive Proprioceptive Odometry for Legged Locomotion](https://arxiv.org/abs/2511.18857)                     | 2025.11 |     | ⏳ 待读 |
...
| 373  | [Legged Robot State-Estimation Through Combined Forward Kinematic and Preintegrated Contact Factors](https://arxiv.org/abs/1712.05873)   | 2017.05 |     | ⏳ 待读 |
...
| #   | 论文                                                                                                                                             | 日期      | 🌟  | 状态   |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------- | --- | ---- |
| 379  | [RAPT: Model-Predictive Out-of-Distribution Detection and Failure Diagnosis for Sim-to-Real Humanoid Robots](https://arxiv.org/abs/2602.01515) | 2026.02 |     | ⏳ 待读 |
...
| 414  | [OSMO: Open-Source Tactile Glove for Human-to-Robot Skill Transfer](https://arxiv.org/abs/2512.08920)                                                                  | 2025.12 |     | ⏳ 待读 |
| 415  | [DIJIT: A Robotic Head for an Active Observer](https://arxiv.org/abs/2512.07998)                                                                                       | 2025.12 |     | ⏳ 待读 |
...
| 417  | [Human-Level Actuation for Humanoids](https://arxiv.org/abs/2511.06796)                                                                                                | 2025.11 |     | ⏳ 待读 |
...
| 419  | [Embracing Evolution: A Call for Body-Control Co-Design in Embodied Humanoid Robot](https://arxiv.org/abs/2510.03081)                                                  | 2025.10 |     | ⏳ 待读 |
...
| 452  | [Learning to Ball: Composing Policies for Long-Horizon Basketball Moves](https://arxiv.org/abs/2509.22442)                                       | 2025.09 |     | ⏳ 待读 |
...
| 454  | [SimGenHOI: Physically Realistic Whole-Body Humanoid-Object Interaction via Generative Modeling and RL](https://arxiv.org/abs/2508.14120)        | 2025.08 |     | ⏳ 待读 |
| 455  | [Humanoid Robot Acrobatics Utilizing Complete Articulated Rigid Body Dynamics](https://arxiv.org/abs/2508.08258)                                 | 2025.08 |     | ⏳ 待读 |
...
| #   | 论文                                                                                                                                   | 日期      | 🌟  | 状态   |
| --- | ------------------------------------------------------------------------------------------------------------------------------------ | ------- | --- | ---- |
| 476  | Learned motion matching                                                                                                              | 6569.33 |     | ⏳ 待读 |
