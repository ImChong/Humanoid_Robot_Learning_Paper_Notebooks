...
## 📎 附录：高影响力精选 H1–H23 进度（含本笔记）

| 类别 | 完成情况 |
|------|----------|
| **全身控制核心**（H1–H6） | H1 Expressive WBC / H2 HOVER / H3 ExBody2 / H4 HugWBC / H5 SONIC / **H6 UH-1（本文）** |
| **遥操作与模仿学习**（H7–H11） | H7 HumanPlus / H8 OmniH2O / H9 HOMIE / H10 EgoMimic / H11 iDP3 |
| **仿真平台与工具**（H21–H23） | H21 Humanoid-Gym / H22 HumanoidBench / H23 BEHAVIOR Robot Suite |

> ✅ 至此 **高影响力精选 H1–H23 已全部完成**。下一轮按循环将无新论文可写，需提示用户在 `papers/03_High_Impact_Selection/` 与 `daily_summary.high_impact_cycle` 中补充新待读论文。
