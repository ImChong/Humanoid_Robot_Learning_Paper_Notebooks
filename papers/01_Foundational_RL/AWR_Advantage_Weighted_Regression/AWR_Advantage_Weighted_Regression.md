...
1. **重要性采样方差大**：PPO/TRPO 依赖重要性采样比率 $\frac{\pi_\theta(a|s)}{\pi_{\theta_{old}}(a|s)}$，当新旧策略差异大时方差爆炸
...
$$\mathcal{L}(\theta) = \mathbb{E}\left[\frac{1}{Z} \exp\left(\frac{A(s, a)}{\beta}\right) \log \pi_\theta(a|s)\right]$$
